          ...
          <div className="section--container  flex justify-center items-center flex-col lg:pt-[1rem]  pt-[26rem] px-5 ">
            ...
            >
              <div
                ...
                className="itiLogo gap-9 hover:bg-[#ffffff1a] transition-all duration-1000 border-2 border-slate-400 rounded-lg flex items-center flex-col justify-center "
              >
                <img
                  style={{ width: "42%", marginTop: "25px" }}
                  src={itiWhite}
                />
                <span
                  style={{ marginTop: "-20px" }}
                  className="text-white animate-bounce text-lg pb-[10px]"
                >
                  HOST
                </span>
              </div>
              <div
                style={{ width: "200px", height: "200px" }}
                className="border-2  hover:bg-[#ffffff1a] transition-all duration-1000 border-slate-400 flex items-center flex-col  justify-center rounded-lg text-center"
              >
                <img style={{ width: "80%" }} src={luxorIeeeLogo} />
                <span className="text-white animate-bounce text-lg ">
                  TECH PARTNER
                </span>
              </div>
            </motion.div>
