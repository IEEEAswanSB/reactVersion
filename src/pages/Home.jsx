        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap items-center mt-24">
            ...
            <div className="w-full md:w-5/12 text-white px-4 mr-auto ml-auto">
              ...
              <Link to="/codestorm" className="font-bold text-blueGray-800 mt-8 w-32 focus:outline-none border border-transparent py-2 px-5 rounded-lg shadow-sm text-center bg-white">
                Register Now!
              </Link>
            </div>
          </div>
