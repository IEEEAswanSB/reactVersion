...
function MenuItem({ link, text, image }) {
  ...
  const repeatedMarqueeContent = Array.from({ length: 10 }).map((_, idx) => (
    <React.Fragment key={idx}>
      ...
      <div
        className="w-[200px] h-[7vh] my-[2em] mx-[2vw] p-[1em_0]  bg-cover bg-center"
  ...
  return (
    <div className="flex-1 relative overflow-hidden text-center shadow-[0_-1px_0_0_#fff]" ref={itemRef}>
      ...
      <div
        className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none bg-[#060606] translate-y-[101%]"
        ref={marqueeRef}
      >
