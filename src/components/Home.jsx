...
function Home() {
  ...
  return (
    ...
    <main>
      ...
      >
        <div
          className="absolute top-0 w-full h-full bg-center bg-cover bg-img"
        >
          <span
            id="blackOverlay"
        ...
        <div className="container relative mx-auto">
          <div className="items-center flex flex-wrap">
            <div className="w-full px-4 ml-auto mr-auto text-center">
                ...
                <p className="mt-1 text-xs text-blueGray-200">
                  Founded 2010
                </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
            ...
            <div className="w-full md:w-4/12 px-4 text-center">
              ...
              >
                <div className="px-4 py-5 flex-auto">
                  ...
                  <p className="mt-2 mb-4 text-blueGray-500">
                    We will be essential to the global technical community and to technical professionals everywhere.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="pt-6 w-full md:w-4/12 px-4 text-center">
              ...
              >
                <div className="px-4 py-5 flex-auto">
                  ...
                  <p className="mt-2 mb-4 text-blueGray-500">
                    Trust, Growth and nurturing, Global community building, Partnership, Service to humanity, and Integrity in action.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-wrap items-center mt-24">
            <div className="w-full md:w-5/12 px-4 mr-auto ml-auto">
              ...
              <p
                className="text-lg font-normal text-justify leading-relaxed mt-4 mb-4 text-blueGray-600"
              >
                IEEE Aswan Student Branch was founded in the academic year (2010-2011), it is located at 
                Aswan Faculty of Engineering and serves all departments within the faculty. We believe that our role is to 
                create a better reality than the one we have, defeat all obstacles and achieve a better tomorrow. For the 
                past 12 years, the branch has provided all students with different technical sessions, soft skills, training, 
            ...
            <div className="w-full md:w-4/12 px-4 mr-auto ml-auto">
              <div
                className="p-6 relative flex flex-col min-w-0 break-words w-full mb-6 rounded-lg"
              >
                <img
                  alt="..."
                  src={logo}
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap items-center mt-24">
            ...
            <div className="w-full md:w-5/12 text-white px-4 mr-auto ml-auto">
              <div
                className="text-blueGray-800 p-3 text-center inline-flex items-center justify-center w-16 h-16 mb-6 shadow-lg rounded-full bg-white"
              >
                <i className="fas fa-info text-xl"></i>
              </div>
              <h3 className="text-3xl mb-2 font-semibold leading-normal">
              ...
              <p
                className="text-lg font-normal text-justify leading-relaxed mt-4 mb-4 text-blueGray-300"
              >
              Be Informed camp is a valuable opportunity that paves the way for Aswan students interested in technological fields, to upgrade the skills required for the labor market, by providing them with courses in different engineering majors by qualified instructors, also technical, and non-technical sessions and talks on trending topics.
              </p>
              {/* <router-link to="/bein" className="font-bold text-blueGray-800 mt-8 w-32 focus:outline-none border border-transparent py-2 px-5 rounded-lg shadow-sm text-center bg-white">
                Register Now!
              </router-link> */}
            </div>
          </div>
          ...
          <div className="flex flex-wrap justify-center text-center mb-24">
            <div className="w-full lg:w-6/12 px-4">
              ...
              <p className="text-lg leading-relaxed m-4 text-blueGray-500">
                The Executive Committee who is responsible for administering our branch operations
              </p>
            </div>
          </div>
          <div className="flex flex-wrap">
      ...
      <section className="pb-20 pt-20 relative bg-blueGray-200 mt-24">
        ...
        <div className="container mx-auto px-4 lg:py-8">
          <div className="w-full mx-auto lg:w-6/12 px-4 text-center">
              <h2 className="text-4xl font-semibold">Our Previous Partners</h2>
              <p className="text-lg leading-relaxed m-4 text-blueGray-500">
