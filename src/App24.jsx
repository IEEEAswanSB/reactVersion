import { CodeStorm } from "./pages/24/CodeStorm";
import {
  BrowserRouter,
  createBrowserRouter,
  RouterProvider,
...
import "./styles/24/index.css";
// import Bein_event from "./components/bein-event";
import React, { Suspense } from "react";
import Home from "./pages/24/Home";

const CodeStormForm = React.lazy(() => import("./pages/24/CodeStormForm"));
const Bein_event = React.lazy(() => import("./components/bein-event"));
const VerifyCodeStorm = React.lazy(() => import("./pages/24/VerifyCodeStorm"));
// const Bein6 = React.lazy(() => import("./pages/24/Bein6"));
import Bein6Attendance from "./pages/24/Bein6Attendance";
import { Box, Typography } from "@mui/material";
// const Bein6Attendance = React.lazy(() => import("./pages/24/Bein6Attendance"));
const Bein6Validate = React.lazy(() => import("./pages/24/Bein6Validate"));
const Bein6Register = React.lazy(() => import("./pages/24/Bein6Register"));
const Bein6Certificate = React.lazy(() =>
  import("./pages/24/Bein6Certificate")
);
const Ending = React.lazy(() => import("./components/Ending"));
const CiCodeStormForm = React.lazy(() => import("./pages/24/ciPage"));
