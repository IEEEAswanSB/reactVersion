...
const credentials = {
  ...
  token_uri: process.env.VITE_API_token_uri,
  auth_provider_x509_cert_url: process.env.VITE_API_auth_provider_x509_cert_url,
  client_x509_cert_url: process.env.VITE_API_client_x509_cert_url,
